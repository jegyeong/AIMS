...
public class MymemTaltoe {
    ...
    // 회원탈퇴 화면에서 확인 버튼 
    @FXML
    void btnCon(ActionEvent event) throws IOException, ClassNotFoundException {
...
//    	
    	...
    	if(input.getText().equals(Session.loginUser.getMem_pass())){
    		...
    		if(AlertUtil.showAlert(stage, "탈퇴  ", "하시겠습니까?", "예", "아니오")) {
    			...
    			FXMLLoader loader = new FXMLLoader (Class.forName("kr.or.ddit.controller.mypage.MymemberController").getResource("../../fxml/main/MainPage.fxml")); // 홈으로 이동하는곳 나중에

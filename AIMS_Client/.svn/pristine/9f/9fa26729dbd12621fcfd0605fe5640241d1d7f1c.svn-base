...
//		}
    ...
    @FXML
    void onClickedMyAuction(MouseEvent event) throws ClassNotFoundException {
    	try {
    		if(lv_myAuction.getSelectionModel().getSelectedItem() == null) return;
    		
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.auction.AuctionMainController").getResource("../../fxml/auction/AuctionRoom.fxml"));
			Parent root = loader.load();
    ...
    @FXML
    void onClickedTotalAuction(MouseEvent event) throws ClassNotFoundException {
    	try {

...
public class NoticeComplainAdminController {
    ...
    @FXML
    void onClickedBtn_Answer(ActionEvent event) throws ClassNotFoundException {
    	try {
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.admin.NoticeAdminMainController").getResource("../../../fxml/notice/admin/NoticComplainAnswerAdmin.fxml"));

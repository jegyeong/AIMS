...
//    		bc.getData().add(ser1);
    		...
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.statistics.Area_StatisticsController").getResource("../../fxml/statistics/statistics_Graph.fxml"));
    ...
    @FXML
    void btnNoticeClick(ActionEvent event) throws IOException, ClassNotFoundException {
    	Stage stage = (Stage) btnNotice.getScene().getWindow();
    	Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.statistics.Area_StatisticsController").getResource("../../fxml/statistics/statistics_notice.fxml"));

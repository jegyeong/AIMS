...
public class ManagerAgencyController {
	...
	@FXML
	void btnAddClicked(ActionEvent event) throws ClassNotFoundException {

		try {
			FXMLLoader loader = new FXMLLoader(
					Class.forName("kr.or.ddit.controller.InformationUse.ManagerAgencyController").getResource("../../fxml/InformationUse/ManagerAgencyDetails.fxml"));

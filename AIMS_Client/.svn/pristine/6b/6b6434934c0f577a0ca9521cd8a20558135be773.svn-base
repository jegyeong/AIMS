...
public class NoticeAdminMainController {
    ...
    void btnHomeClick(ActionEvent event) throws IOException, ClassNotFoundException {
    	FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.admin.NoticeAdminMainController").getResource("../../../fxml/adminmain/AdminMain.fxml"));
    ...
    @FXML
    void onClickedeBtn_Com(ActionEvent event) throws ClassNotFoundException {
    	try {
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.admin.NoticeAdminMainController").getResource("../../../fxml/notice/admin/NoticComplainListAdmin.fxml"));
    		Parent root = loader.load();
    ...
    void onClickedeBtn_Notice(ActionEvent event) throws ClassNotFoundException {
    	try {
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.admin.NoticeAdminMainController").getResource("../../../fxml/notice/admin/NoticeAdmin.fxml"));
    		Parent root = loader.load();

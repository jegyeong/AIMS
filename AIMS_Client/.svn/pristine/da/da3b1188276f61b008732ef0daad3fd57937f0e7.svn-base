...
public class NoticeMainController {
    ...
    public void setDialog(String name) throws ClassNotFoundException {
    	if(name.equals("notice")) {
    		try {
        		Parent  root =FXMLLoader.load(Class.forName("kr.or.ddit.controller.notice.user.NoticeMainController").getResource("../../../fxml/notice/user/Notice.fxml")); 	
        		...
        		try {
            		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.user.NoticeMainController").getResource("../../../fxml/notice/user/Qusetion.fxml"));
    ...
    @FXML
    void onClickedeBtn_Answer(ActionEvent event) throws ClassNotFoundException {
    ...
    @FXML
    void onClickedeBtn_Notice(ActionEvent event) throws ClassNotFoundException {
    	try {
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.user.NoticeMainController").getResource("../../../fxml/notice/user/Notice.fxml"));
    		Parent  root = loader.load();

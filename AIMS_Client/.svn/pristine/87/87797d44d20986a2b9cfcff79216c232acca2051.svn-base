    	...
    	formatTable.setOnMouseClicked(e -> {
    		try {
    	    	...
    	    	try {
    	    		...
    	    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.knowledge.user.AuctionFormatController").getResource("../../../fxml/knowledge/user/formatDown.fxml"));

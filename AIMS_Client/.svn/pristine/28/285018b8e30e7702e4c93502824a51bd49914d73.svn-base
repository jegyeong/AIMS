...
public class MainTemplateController {
	...
	void btnAgencyClicked(ActionEvent event) throws ClassNotFoundException {
		...
		try {
			FXMLLoader loader = new FXMLLoader(
					Class.forName("kr.or.ddit.controller.InformationUse.MainTemplateController").getResource("../../fxml/InformationUse/Agency.fxml"));
	...
	void btnFAQClicked(ActionEvent event) throws ClassNotFoundException {
		try {
			FXMLLoader loader = new FXMLLoader(
					Class.forName("kr.or.ddit.controller.InformationUse.MainTemplateController").getResource("../../fxml/InformationUse/FAQ.fxml"));
			Parent root = loader.load();
	...
	@FXML
	void btnHomeClicked(ActionEvent event) throws ClassNotFoundException { // 홈으로
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.InformationUse.MainTemplateController").getResource("../../fxml/main/MainPage.fxml"));
			Parent root = loader.load();
	...
	void btnSiteMapClicked(ActionEvent event) throws ClassNotFoundException {
		try {
			Parent root = FXMLLoader
					.load(Class.forName("kr.or.ddit.controller.InformationUse.MainTemplateController").getResource("../../fxml/InformationUse/SiteMap.fxml"));
			if (contentsArea.getChildren().size() != 0) {
				for (int i = 0; i < contentsArea.getChildren().size(); i++) {
					contentsArea.getChildren().remove(i);
				}

...
public class NoticeModifyAdminController {
	...
	@FXML
	void onClickedBtn_Back(ActionEvent event) throws ClassNotFoundException {
		try {
			FXMLLoader loader = new FXMLLoader(
					Class.forName("kr.or.ddit.controller.notice.admin.NoticeModifyAdminController").getResource("../../../fxml/notice/admin/NoticeAdmin.fxml"));
	...
	@FXML
	void onClickedBtn_Delete(ActionEvent event) throws ClassNotFoundException {
	...
	@FXML
	void onClickedBtn_Modify(ActionEvent event) throws ClassNotFoundException {
		try {
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.admin.NoticeModifyAdminController").getResource("../../../fxml/notice/admin/NoticModifyAdmin2.fxml"));
			Parent root = loader.load();

...
public class MymemberController {
	...
	private IMymemberService service2;
    ...
    void btcShcedual(ActionEvent event) throws IOException {
    	try {
			setAADialog("../../fxml/mypage/MySchedual.fxml");
    ...
    void btnAut(ActionEvent event) throws IOException {
    	try {
			setAADialog("../../fxml/mypage/MyAuction.fxml");
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
    }
    ...
    void btnHome(ActionEvent event) throws ClassNotFoundException {
        	...
        	if(AlertUtil.showAlert(currentStage, "메인페이지로  ","이동하시겠습니까?","이동","취소")) {
        		
        		Stage stage = (Stage)home.getScene().getWindow();
        		
        		try {
        			Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.My.MymemberController").getResource("../../fxml/main/MainPage.fxml"));
    ...
    void btnInfo(ActionEvent event) throws IOException {
    	try {
			setAADialog("../../fxml/mypage/MyInformation.fxml");
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
    }
    ...
    void btnInters(ActionEvent event) throws IOException {
    	try {
			setAADialog("../../fxml/mypage/MymemInterest.fxml");
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
    }
    ...
    void btnMinwon(ActionEvent event) throws IOException {
    	try {
			setAADialog("../../fxml/mypage/Com_QuestionController.fxml");
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
    }
    ...
    void btnSection(ActionEvent event) throws IOException {
    	try {
			setAADialog("../../fxml/mypage/Mymemtaltoe.fxml");
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
    }
    
    public void setAADialog(String path) throws ClassNotFoundException {
		try {
			Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.My.MymemberController").getResource(path));

...
//    	fileChooser.getExtensionFilters().addAll(new E )
    ...
    //삭제버튼
    @FXML
    void btnFrontDeleteClicked(ActionEvent event) throws ClassNotFoundException {
    	if(AlertUtil.showAlert((Stage) btnConfirm.getScene().getWindow(), "FAQ삭제하시겠습니까?")) {
    		...
    		if(cnt!=0) {
    			try {
            		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.InformationUse.ManagerFAQDetailsController").getResource("../../fxml/InformationUse/ManagerFAQ.fxml"));
    ...
    @FXML
    void btnConfirmClicked(ActionEvent event) throws ClassNotFoundException {

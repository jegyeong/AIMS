...
//    	tfContents.setText(faqVo.getFaq_content());
    ...
    @FXML
    void btnDeleteClicked(ActionEvent event) throws ClassNotFoundException {
    	try {
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.InformationUse.ManagerAgencyDeitalsController").getResource("../../fxml/InformationUse/ManagerAgency.fxml"));
    ...
    @FXML
    void btnFrontModiClcied(ActionEvent event) throws ClassNotFoundException {

...
//    }
    ...
    //자세히 보기 버튼(수정)버튼 클릭
    @FXML
    void btnModifyClicked(ActionEvent event) throws ClassNotFoundException {
    	...
    	try {
	    	...
	    	FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.InformationUse.ManagerFAQController").getResource("../../fxml/InformationUse/ManagerFAQDetails.fxml"));
    ...
    @FXML
    void tableClicked(MouseEvent event) throws ClassNotFoundException {
    	try {
	    	FAQVO faqVo = tableView.getSelectionModel().getSelectedItem();

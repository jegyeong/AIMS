...
public class loginController {
	...
	@FXML
	void btn_confirm_clicked(MouseEvent event) throws ClassNotFoundException {
		try {
	...
	void setnextDialog(String nextPage) throws ClassNotFoundException {
		try {
			Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.login.loginController").getResource(nextPage));
...
//	
    @FXML
    void btn_find_id_clicked(MouseEvent event) throws ClassNotFoundException {
    	try {
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.login.loginController").getResource("../../fxml/findIdPass/FindId.fxml"));
    ...
    @FXML
    void btn_find_pass_clicked(MouseEvent event) throws ClassNotFoundException {
    	try {
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.login.loginController").getResource("../../fxml/findIdPass/FindPass.fxml"));
			Parent root = loader.load();
		...
		logo.setOnMouseClicked(new EventHandler<Event>() {
			...
			public void handle(Event event) {
				try {
					...
					FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.login.loginController").getResource("../../fxml/main/MainPage.fxml"));
					Parent root = loader.load();

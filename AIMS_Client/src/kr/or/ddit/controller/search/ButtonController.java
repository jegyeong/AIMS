...
public class ButtonController {
    ...
    void btnHomeClick(ActionEvent event) throws ClassNotFoundException {
		...
		try {
			Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.search.ButtonController").getResource("../../fxml/main/MainPage.fxml"));
    ...
    public void mainSearchCall(CourtVO cou,String loc) throws ClassNotFoundException {
 
    	
    	try {
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.search.ButtonController").getResource("../../fxml/search/fxmlCourt.fxml"));
	...
	public void setAADialog(String path) {
		try {
			Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.search.ButtonController").getResource(path));

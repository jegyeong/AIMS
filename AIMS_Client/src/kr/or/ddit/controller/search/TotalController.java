...
public class TotalController {
    ...
    void btnSearchClick(ActionEvent event) {
    	...
    	if(CA.getValue()!=null) {
    		data.put("catA",CA.getValue().getCat_a_no());
    	}
    	
    	if(CB.getValue()!=null) {
    		data.put("catA",CB.getValue().getCat_b_no());
    	}
    	if(CC.getValue()!=null) {
    		data.put("catA",CC.getValue().getCat_c_no());
    	}
    ...
    void tableClick(MouseEvent event) throws IOException, ClassNotFoundException {
    	...
    	controller.setNextPage("../../fxml/search/fxmlTotal.fxml");

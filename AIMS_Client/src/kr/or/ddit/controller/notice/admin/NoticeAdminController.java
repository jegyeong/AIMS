...
public class NoticeAdminController {
	...
	@FXML
	void onClickeBtn_Add(ActionEvent event) throws ClassNotFoundException {
		try {
			Stage stage = (Stage) btn_Add.getScene().getWindow();
			FXMLLoader loader = new FXMLLoader(
					Class.forName("kr.or.ddit.controller.notice.admin.NoticeAdminMainController").getResource("../../../fxml/notice/admin/NoticeAddAdmin.fxml"));
	...
	@FXML
	void onClickedTb_Notice(MouseEvent event) throws ClassNotFoundException {
//    	Scene scene = btn_Add.getScene();
		Stage stage = (Stage) btn_Add.getScene().getWindow();
		try {
			FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.notice.admin.NoticeAdminMainController").getResource("../../../fxml/notice/admin/NoticModifyAdmin.fxml"));
			Parent root = loader.load();

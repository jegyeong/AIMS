...
public class AddSearch {
	...
	private MemberInfoModifyController dialog;
	
	
    public MemberInfoModifyController getDialog() {
		return dialog;
	}

	public void setDialog(MemberInfoModifyController dialog) {
		this.dialog = dialog;
	}
	
	
	public void setDialog(MyInformationController myInformationController) {
    ...
    @FXML
    void listview(MouseEvent event) throws IOException, ClassNotFoundException {
    	// 화면전환
    	FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.adminmypage.AddSearch").getResource("../../fxml/adminmypage/AddSearch2.fxml"));

...
public class AdminKnowledgeFormatController {
    ...
    void ListClick(MouseEvent event) {
    	...
    	try {
    		...
    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.knowledge.admin.AdminKnowledgeFormatController").getResource("../../../fxml/knowledge/admin/formatEdit.fxml"));
    ...
    void btnAddClick(ActionEvent event) throws IOException, ClassNotFoundException {
    	...
    	Parent add = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.AdminKnowledgeFormatController").getResource("../../../fxml/knowledge/admin/formatAdd.fxml"));
    ...
    void btnHomeClick(ActionEvent event) throws IOException, ClassNotFoundException {
    	...
    	Parent main = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.AdminKnowledgeFormatController").getResource("../../../fxml/knowledge/admin/adminKnowledgeMain.fxml"));

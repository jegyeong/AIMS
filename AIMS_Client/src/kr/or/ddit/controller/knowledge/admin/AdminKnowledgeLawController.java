...
public class AdminKnowledgeLawController {
	...
	void btnAddClick(ActionEvent event) throws IOException, ClassNotFoundException {
		...
		Parent add = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.AdminKnowledgeLawController").getResource("../../../fxml/law/fxmlLawAdd.fxml"));
	...
	void btnHomeClick(ActionEvent event) throws IOException, ClassNotFoundException {
		...
		Parent main = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.AdminKnowledgeLawController").getResource("../../../fxml/knowledge/admin/adminKnowledgeMain.fxml"));
    ...
    @FXML
    void lawTableClick(MouseEvent event) throws IOException, ClassNotFoundException {
    	FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.knowledge.admin.AdminKnowledgeLawController").getResource("../../../fxml/law/fxmlLawEdit.fxml"));

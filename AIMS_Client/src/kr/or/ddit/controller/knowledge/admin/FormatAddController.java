...
public class FormatAddController {
    ...
    void btnAddClick(ActionEvent event) {
    	try {
    		Parent alert = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.FormatAddController").getResource("../../../AlertDialog/AlertDialog2.fxml"));
        	...
        	Parent main = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.FormatAddController").getResource("../../../fxml/knowledge/admin/adminKnowledgeFormat.fxml"));
    ...
    void btnHomeClick(ActionEvent event) throws IOException, ClassNotFoundException {
    	Stage stage = (Stage) btnHome.getScene().getWindow();
    	Parent main = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.admin.FormatAddController").getResource("../../../fxml/knowledge/admin/adminKnowledgeMain.fxml"));

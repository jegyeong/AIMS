...
public class KnowledgeMainController {
    ...
    @FXML
    void btnBackClick(ActionEvent event) throws ClassNotFoundException {
    	Stage stage = (Stage)btnHome.getScene().getWindow();
    	
		try {
			Parent root = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.user.FXMLSearchMain").getResource("../../fxml/main/MainPage.fxml"));
    ...
    void initialize() {
    	...
    	Parent step = FXMLLoader.load(Class.forName("kr.or.ddit.controller.knowledge.user.KnowledgeMainController").getResource("../../../fxml/knowledge/user/auctionStep.fxml"));

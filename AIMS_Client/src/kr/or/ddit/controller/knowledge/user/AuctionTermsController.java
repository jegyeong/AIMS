        ...
        termsTable.setOnMouseClicked(e -> {
        	try {
    	    	...
    	    	try {
    	    		...
    	    		FXMLLoader loader = new FXMLLoader(Class.forName("kr.or.ddit.controller.knowledge.user.AuctionTermsController").getResource("../../../fxml/knowledge/user/termShow.fxml"));
